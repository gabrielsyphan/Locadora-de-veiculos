...
public class FuncoesBanco {
    ...
    public void registrarDevolucaoVeiculo(int codigo_locacao, String data_devolucao, String placa){
        this.conexaoSQLite.conectar();
        ...
        try{
            ...
            preparedStatement.executeUpdate();
            alterarDiponibilidadeVeiculo(placa, "Disponivel");
   ...
   public ArrayList getTodosVeiculos(){
    ...
    public boolean verificarDisponibilidadeVeiculo2(String placa){
    ...
    public int buscarLocacaoVeiculoAlugado(String placa){
        if(this.verificarExistenciaVeiculo(placa)){
            if(!this.verificarDisponibilidadeVeiculo2(placa)){
        this.conexaoSQLite.conectar(); 
        ArrayList<Locacao> l = new ArrayList<Locacao>();
        ResultSet resultSet = null;
        PreparedStatement preparedStatement = null;
        ...
        try{
            ...
            while(resultSet.next()){
                ...
                System.out.println("Codigo = "+ resultSet.getInt("codigo"));
                System.out.println("Placa Veiculo = "+resultSet.getString("placa_veiculo"));
                System.out.println("CPF Cliente = "+resultSet.getString("cpf_cliente"));
                System.out.println("Data Locacao = "+resultSet.getString("data_locacao"));
                System.out.println("Data Devolucao = "+resultSet.getString("data_devolucao"));
                l.add(new Locacao(resultSet.getInt("codigo"),resultSet.getString("placa_veiculo"),resultSet.getString("cpf_cliente"),resultSet.getString("data_locacao"),resultSet.getString("data_devolucao")));
            }
            if(l.isEmpty()){
                JOptionPane.showMessageDialog(null, "O veículo não está locado");
                return 0;
            }else{
                return l.get(l.size()-1).getCodigo();
